...
class UserRoutes {
    ...
    getUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const user = yield User_1.default.findOne({ username: req.params.username }).populate('posts', 'title url -_id'); // Obtiene solo el titulo y url, sin id
    ...
    createUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield newUser.save(); // Devuelve Json
